      ...
      <View style={{ flex: 1, backgroundColor: "#fff" }}>
        ...
        <View style={[styles.SearchButtonContainer]}>
          <Searchbar
            ...
            elevation={4}
          />
          <ThemedButtonFilter style={styles.filterButton}></ThemedButtonFilter>
        ...
        style={{}}
          data={data}
          numColumns={2}
          renderItem={({ item }) => <ThemedCard image={item.image} title={item.title} Description={item.Description} rating={item.rating} />}
